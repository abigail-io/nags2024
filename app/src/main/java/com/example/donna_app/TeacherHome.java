            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_dashboard:
                        Intent dashboardIntent = new Intent(TeacherHome.this, DashboardActivity.class);
                        startActivity(dashboardIntent);
                        break;
                    case R.id.nav_profile:
                        Intent profileIntent = new Intent(TeacherHome.this, TeacherProfileActivity.class);
