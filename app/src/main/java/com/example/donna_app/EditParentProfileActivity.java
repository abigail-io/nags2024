...
public class EditParentProfileActivity extends AppCompatActivity {
    ...
    private static final String API_URL_PROFILE_UPDATE = "http://192.168.55.119:8000/api/updateparent";
    ...
    private void updateProfile() {
        ...
        if (parentFName.isEmpty() || parentLName.isEmpty() || parentAddress.isEmpty() || parentPhone.isEmpty()) {
    ...
    private String getParentAddress() {
        EditText parentAddressEditText = findViewById(R.id.addressEditText);
        return parentAddressEditText.getText().toString();
    }
